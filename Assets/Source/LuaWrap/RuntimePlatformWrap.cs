...
public class RuntimePlatformWrap
{
	static LuaMethod[] enums = new LuaMethod[]
	{
		...
		new LuaMethod("WiiU", GetWiiU),
		new LuaMethod("tvOS", GettvOS),
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetWiiU(IntPtr L)
	{
		LuaScriptMgr.Push(L, RuntimePlatform.WiiU);
		return 1;
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GettvOS(IntPtr L)
	{
		LuaScriptMgr.Push(L, RuntimePlatform.tvOS);
		return 1;
	}
