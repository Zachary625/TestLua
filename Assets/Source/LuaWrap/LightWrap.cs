...
public class LightWrap
{
	public static void Register(IntPtr L)
	{
		...
		LuaField[] fields = new LuaField[]
		{
			...
			new LuaField("bakedIndex", get_bakedIndex, set_bakedIndex),
	...
	static int get_bakedIndex(IntPtr L)
	{
		...
		LuaScriptMgr.Push(L, obj.bakedIndex);
		return 1;
	}
	...
	static int set_shadowResolution(IntPtr L)
	{
		...
		obj.shadowResolution = (LightShadowResolution)LuaScriptMgr.GetNetObject(L, 3, typeof(LightShadowResolution));
		return 0;
	}
	...
	static int set_bakedIndex(IntPtr L)
	{
		...
		obj.bakedIndex = (int)LuaScriptMgr.GetNumber(L, 3);
		return 0;
	}
