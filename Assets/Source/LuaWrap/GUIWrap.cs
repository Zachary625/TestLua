...
public class GUIWrap
{
	...
	static int BeginClip(IntPtr L)
	{
		...
		else if (count == 4)
		{
			...
			bool arg3 = LuaScriptMgr.GetBoolean(L, 4);
			GUI.BeginClip(arg0,arg1,arg2,arg3);
			return 0;
		}
		else
		{
			LuaDLL.luaL_error(L, "invalid arguments to method: GUI.BeginClip");
		}
